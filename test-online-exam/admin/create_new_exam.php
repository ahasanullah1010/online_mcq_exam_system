...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($exam_title) || empty($description) || empty($starting_time) || empty($duration) || empty($status)) {
        ...
        if ($stmt = $conn->prepare($query)) {
            ...
            // Execute the query
            if ($stmt->execute()) {
                header('Location:add_question_to_exam.php');
            } else {
...
<body>
    ...
    <nav class="d-block d-md-none navbar navbar-dark bg-dark">
        ...
        <div id="dropdownMenu" class="dropdown-menu">
            ...
            <a href="create_new_exam.php" class="active"><i class="fas fa-plus me-2"></i> Add New Exam</a>
                ...
                <div class="form-container">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="exam_title" name="exam_title" class="form-control" placeholder="Enter exam title" required>
                        </div>

                        <div class="mb-3">
                            <label for="description" class="form-label">Description</label>
                            <textarea id="description" name="description" class="form-control" rows="4" placeholder="Enter exam description" required></textarea>
                        </div>

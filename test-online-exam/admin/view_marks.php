...
// fetch results and students info
$user_id = $_SESSION['userID'];
$exam_id = $_GET['exam_id'];
$query = "SELECT 
results.score AS score, results.total_score as total_score, users.username as username, users.name as name, users.user_id as id
FROM 
results
INNER JOIN 
users

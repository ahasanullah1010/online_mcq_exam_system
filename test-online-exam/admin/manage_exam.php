...
<body>
    ...
    <div class="sidebar d-none d-md-block">
        ...
        <a href="manage_exam.php" class="active"><i class="fas fa-book me-2"></i> Manage Exams</a>
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <!-- Add Exam Button -->
            <button class="btn btn-primary add-exam-btn"><i class="fas fa-plus me-2"></i>
                <a href="create_new_exam.php" style="color: white;">Add New Exam</a>
            </button>
            ...
            <div class="card">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <?php 
                            // Fetch upcoming and pending exams from the exams table
                            ...
                            <tr>
                                ...
                                <td><a href="./query/review_question.php?exam_id=<?= $exam['exam_id'] ?>">Review</a></td>
                                <td><a href="./query/submit_to_schedule.php?exam_id=<?= $exam['exam_id'] ?>">Submit</a></td>
                                <td>
                                    <a href="edit_exam.php?exam_id=<?= $exam['exam_id']?>">
                                    <button class="btn btn-sm btn-info me-2"><i class="fas fa-edit"></i></button>
                                    </a>
                                    <a href="./query/delete_exam.php?exam_id=<?= $exam['exam_id']?>">
             ...
             <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Upcoming Exams List</h5>
                </div>
                <div class="card-body table-responsive">
                    <table class="table table-striped">
                        <thead>
                        ...
                        <tbody>
                        <?php 
                            // Fetch upcoming and scheduled exams from the exams table
                            $user_id = $_SESSION['userID'];
                            date_default_timezone_set('Asia/Dhaka');
                            $d = date("Y-m-d H:i:s");
                            $query = "SELECT * FROM exams where user_id = $user_id AND date > '$d' AND status = 'scheduled'  ORDER BY date ASC";
                            $result = $conn->query($query);
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Exams Already Finished </h5>
                </div>
                <div class="card-body table-responsive">
                    <table class="table table-striped">
                        <thead>
                        ...
                        <?php 
                            ...
                            date_default_timezone_set('Asia/Dhaka');
                            $d = date("Y-m-d H:i:s");
                            $query = "SELECT * FROM exams where user_id = $user_id AND date < '$d'  ORDER BY date DESC";
                            $result = $conn->query($query);

...
$d = date("Y-m-d H:i:s");
// $query = "SELECT * FROM exams where  date < '$d' AND status = 'scheduled'  ORDER BY date DESC";
$query = "SELECT 
exams.title AS title,exams.description as description, exams.date as date, results.score as score, results.total_score as total_score
FROM 
exams
INNER JOIN 
results
...
<body>
    ...
    <nav class="d-block d-md-none navbar navbar-dark bg-dark">
        ...
        <div id="dropdownMenu" class="dropdown-menu">
            ...
            <a href="" class="dropdown-item"><i class="fas fa-poll me-2"></i> View Results</a>
    ...
    <div class="sidebar d-none d-md-block">
        ...
        <a href="attempted_exam.php" class="active"> <i class="bi bi-list-check me-2" ></i>  Attempted Exams</a>
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h2 class="mb-4">Attempted Exams - </h2>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Attempted Exam details and Marks </h5>
                </div>

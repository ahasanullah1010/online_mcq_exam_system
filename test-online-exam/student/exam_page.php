...
<body>
    ...
    <div class="container">
        <?php if(isset($exam['title'])){
            $t=$exam['title'];
            echo "<h2>Exam Title : $t</h2>";
        }
        ?>
    <h3 ><span id="later">Exam will be start after : -- </span></h3>
    <h2 style="text-align: right;"> <span id="timer"></span></h2>
        <form id="examForm" action="calculate_result.php?exam_id=<?= $exam_id ?>" method="POST">
